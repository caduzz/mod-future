...
public final class ChessBlockbenchModelLoader {
    ...
    public static final ResourceLocation PAWN_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/pawn.json");
    public static final ResourceLocation TOWER_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/tower.json");
    public static final ResourceLocation HORSE_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/horse.json");
    public static final ResourceLocation BISHOP_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/bishop.json");
    public static final ResourceLocation QUEEN_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/queen.json");
    public static final ResourceLocation KING_MODEL = ResourceLocation.fromNamespaceAndPath("futuremod", "models/block/king.json");
    ...
    private static final class Reloader implements PreparableReloadListener {
        ...
        public String getName() {
            return "futuremod:chess_blockbench_models";
        }
    }
